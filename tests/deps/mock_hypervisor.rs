...
pub struct Mock_Hypervisor;

impl ApexPartitionP4 for Mock_Hypervisor {
    fn get_partition_status<L: Locked>() -> ApexPartitionStatus {
        let status = ApexPartitionStatus {
            period: (10),
            duration: (10),
            identifier: (0),
            lock_level: (0),
...
impl ApexQueuingPortP1 for Mock_Hypervisor {
...
impl ApexQueuingPortP4 for Mock_Hypervisor {
...
impl ApexSamplingPortP4 for Mock_Hypervisor {
...
impl ApexSamplingPortP1 for Mock_Hypervisor {
...
impl ApexProcessP4 for Mock_Hypervisor {
...
impl ApexProcessP1 for Mock_Hypervisor {
...
impl ApexTimeP4 for Mock_Hypervisor {
